...
class ExecutionSimulator:
    ...
    def simulate_fill(
        ...
        # Effective price = mid + side*(spread + impact) - side*limit_offset_in_price
        ...
        raw_price = mid_price + direction * (half_spread_cost + impact_cost) - direction * limit_offset_price
