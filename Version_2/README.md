...
Version 2 kept the ideas and rebuilt the machinery: PyTorch, 99 tickers trained in parallel, and one action pipeline shared by training, backtest, and live.
