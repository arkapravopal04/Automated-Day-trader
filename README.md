...
> Building a fully autonomous trading system from scratch and no high-level ML libraries.  
> Core: custom autograd engine over a DAG with topological-sort-driven backpropagation.  
> Status: actively ongoing with NLP front-end and LSTM in progress.

---

This is a personal project that I am currently working on.
As the name suggests I aim to make a completely automated day trader i.e. a "bot" that can make decisions by itself. This would work using some kind of NLP or LLM to understand market data and make decisions from that.
