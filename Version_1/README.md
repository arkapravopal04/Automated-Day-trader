# Version 1 — Legacy (Archived)

> **This is the archived documentation of Version 1, the original from-scratch build.**
> It is kept for reference only — Version 1 is no longer developed. The active
> system is Version 2 (see the [root README](../README.md)). This page documents
> the NumPy-only autograd engine, the original PPO agent, and the lessons that
> led to the Version 2 rewrite.
